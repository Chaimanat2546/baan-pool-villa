...
describe("/api/site-theme.css", () => {
  ...
  it("returns scoped theme CSS for valid query values", async () => {
    const response = GET(
      new Request(
        "https://example.com/api/site-theme.css?primary=%23064e3b&accent=%23eab308&headerLink=%23f8fafc&headerLinkHover=%23fde68a&footerLink=%23e2e8f0&footerLinkHover=%23facc15&bankHighlight=%23fde047&scope=settings-preview-theme",
      ),
    );
