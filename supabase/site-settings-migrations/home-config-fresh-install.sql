...
-- BEGIN 20260826000000_add_tiktok_video_house_ids.sql
...
notify pgrst, 'reload schema';
-- END 20260826000000_add_tiktok_video_house_ids.sql

-- BEGIN 20260828140000_restore_admin_credential_fence_after_site_settings_rls.sql
...
notify pgrst, 'reload schema';
-- END 20260828140000_restore_admin_credential_fence_after_site_settings_rls.sql

-- BEGIN 20260902113000_add_gallery_category_order_constraint.sql
...
notify pgrst, 'reload schema';
-- END 20260902113000_add_gallery_category_order_constraint.sql

-- BEGIN 20260902140000_add_gallery_show_cover_option.sql
alter table public.site_web_styles
  drop constraint if exists site_web_styles_options_check;
...
notify pgrst, 'reload schema';
-- END 20260902140000_add_gallery_show_cover_option.sql

-- BEGIN 20260902153500_add_gallery_image_source_option.sql
alter table public.site_web_styles
  drop constraint if exists site_web_styles_options_check;
...
notify pgrst, 'reload schema';
-- END 20260902153500_add_gallery_image_source_option.sql

-- BEGIN 20260902164500_remove_uncategorized_gallery_category.sql
alter table public.site_web_styles
  drop constraint if exists site_web_styles_options_check;
...
notify pgrst, 'reload schema';
-- END 20260902164500_remove_uncategorized_gallery_category.sql
