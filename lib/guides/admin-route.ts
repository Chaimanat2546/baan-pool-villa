...
export type AdminGuideDraft = GuideDraft & { id?: string };
...
export function readGuidePayload(payload: unknown):
  | {
...
export function mapToSaveRow(guide: GuideDraft) {
...
export async function loadSlugRows(supabase: HomeConfigSupabaseClient) {
...
export function readDeleteGuidePayload(payload: unknown):
  ...
  if (!isRecord(payload) || typeof payload.id !== "string") {
    return { id: null, slug: null, errors: ["Body must contain a guide id."] };
  }
