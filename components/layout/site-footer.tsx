  ...
  return (
    <footer className="bg-[var(--site-primary)] pb-28 text-[var(--site-footer-link)] md:pb-0" style={siteThemeStyle}>
      <div className="mx-auto grid max-w-[1292px] gap-10 px-6 pb-16 pt-14 sm:px-8 lg:grid-cols-[1.45fr_0.7fr_0.9fr] lg:gap-20 lg:px-6 lg:pb-16 lg:pt-[60px]">
        <div>
          <div className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-3 gap-y-1 xl:grid-cols-[auto_minmax(0,1fr)_auto] xl:grid-rows-[auto_auto] xl:gap-x-3 xl:gap-y-1">
              <span className={`relative h-16 w-16 shrink-0 overflow-hidden rounded-[18px] border-4 p-2 ${logoBackgroundClass} ${logoBorderClass} ${shouldShowFollowButton ? "row-span-2" : ""} xl:row-span-2`}>
                <Image
                  src={logoImageSrc}
              ...
              <div className="col-start-2 row-start-1 min-w-0 xl:col-start-2 xl:row-start-1 xl:self-end">
            ...
            {shouldShowFollowButton ? (
              <a
                ...
                className="col-start-2 row-start-2 inline-flex shrink-0 justify-self-start items-center justify-center gap-1.5 rounded-sm bg-[#1877F2] px-2 py-1 text-sm text-white transition hover:bg-[#166FE5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--site-primary)] xl:col-start-3 xl:row-start-1 xl:self-end border-white/50 border-[1px] shadow-2xl"
                href={facebookPageUrl.toString()}
                rel="noreferrer"
                target="_blank"
              >
              ...
              <div className={`col-span-2 ${shouldShowFollowButton ? "row-start-3" : "row-start-2"} min-w-0 xl:col-start-2 xl:col-end-4 xl:row-start-2`}>
