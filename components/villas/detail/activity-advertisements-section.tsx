      ...
      <div className="mt-5 max-h-[292px] space-y-3 overflow-y-auto overflow-x-hidden pr-2">
        {visibleAdvertisements.map(({ advertisement, imageUrls }) => (
          ...
          >
            ...
            <div className="grid min-w-0 flex-1 content-center gap-3">
              <h3 className="line-clamp-2 text-base font-black leading-6 text-[var(--site-text)]">
                {advertisement.title}
              </h3>
              <span className="inline-flex w-fit items-center rounded-full bg-[var(--site-primary)] px-3 py-2 text-sm font-black text-[var(--site-on-primary)] transition group-hover:opacity-90">
                ดูรูปกิจกรรม
              </span>
            </div>
          </button>
