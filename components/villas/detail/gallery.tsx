  ...
  return (
    ...
    >
      {item.url ? (
        ...
        <div className="grid h-full place-items-center text-[#55746b]">
...
export function GalleryLightbox({
  ...
  return (
    <div className="fixed inset-0 z-[70] bg-[#031f1a]/95 text-white">
      <div className="flex h-dvh flex-col">
        <header className="flex shrink-0 items-center justify-between gap-3 border-b border-white/10 px-4 py-3 sm:px-6">
          <div className="min-w-0">
            <p className="text-[11px] font-black uppercase tracking-[0.14em] text-white/55 sm:text-xs sm:tracking-[0.18em]">
              แกลเลอรีรูปบ้าน
            </p>
        ...
        <div className="shrink-0 border-b border-white/10 px-4 py-3 sm:px-6">
          <div className="mb-2 flex items-center justify-between gap-3">
            <p className="text-xs font-black text-white/60">เลือกหมวดหมู่</p>
            <p className="text-[11px] font-bold text-white/45 lg:hidden">เลื่อนซ้ายขวา</p>
          </div>
        ...
        <div className="grid min-h-0 min-w-0 flex-1 grid-cols-1 gap-4 overflow-y-auto overflow-x-hidden px-4 py-4 sm:px-6 lg:grid-cols-[minmax(0,1fr)_240px] lg:overflow-hidden">
          ...
          <aside className="min-h-0 min-w-0 max-w-full lg:overflow-y-auto">
            <div className="rounded-2xl bg-white/8 p-4">
              <p className="text-xs font-black text-white/55">หมวดรูป</p>
